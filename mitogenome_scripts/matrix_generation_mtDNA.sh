...
#type 'bash matrix_generation.sh FOLDER_MITOZ_ANNOTATION_RESULTS'
#tools used in this script: seqkit, csvtk, parallel, FASconCAT, mafft, trimal, TransDecoder, PhyKIT, IQ-TREE
