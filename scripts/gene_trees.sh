...
if [ "$ALIGN_TYPE" == "1" ]; then
  ...
  [ "$MODEL_INPUT" == "5" ] && MODEL="--mset LG+C20+FO+R"
  [ "$MODEL_INPUT" == "6" ] && MODEL="--msub mitochondrial"
