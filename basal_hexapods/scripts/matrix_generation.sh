...
#check FASconCAT-G_v1.05.1.pl
if [ $(which FASconCAT-G_v1.05.1.pl) ]
    then
      echo "FASconCAT-G_v1.05.1.pl ...... OK"
      EXE_FASCONCAT=$(which FASconCAT-G_v1.05.1.pl)
      DIR_FASCONCAT=${EXE_FASCONCAT%/*}
    else
      until [ -x $DIR_FASCONCAT/FASconCAT-G_v1.05.1.pl ]
        do
          read -p "FASconCAT-G_v1.05.1.pl is not found. Please input its installation directory (absolute path, e.g. /home/zf/install/FASconCAT-G-1.05/FASconCAT-G_v1.05.1.pl):      " DIR_FASCONCAT_TEMP
